...
<p class="has-contrast-color has-text-color" style="margin-top:2rem;font-family:var(--wp--preset--font-family--body);font-size:1.125rem;font-weight:200;line-height:1.75"><?php echo esc_html__( 'Heritage restoration at Concrete & Light is not preservation for its own sake. It is a conversation between centuries — an act of careful listening to the original structure before introducing contemporary interventions that serve present-day needs while honouring the building\'s memory.', 'concrete-and-light' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-contrast-color has-text-color" style="margin-top:1.5rem;font-family:var(--wp--preset--font-family--body);font-size:1.125rem;font-weight:200;line-height:1.75"><?php echo esc_html__( 'Our approach is rooted in material honesty: new concrete volumes are left raw and unfinished to clearly distinguish them from the original stone and plaster, creating a legible timeline within each space.', 'concrete-and-light' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<p class="has-muted-color has-text-color" style="margin-top:1rem;font-family:var(--wp--preset--font-family--body);font-size:0.8125rem;font-weight:300;letter-spacing:0.1em;text-transform:uppercase"><?php echo esc_html__( 'Founding Principle', 'concrete-and-light' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:33.33%"><!-- wp:group {"style":{"border":{"width":"1px","color":"var:preset|color|border-subtle"},"spacing":{"padding":{"top":"2rem","bottom":"2rem","left":"1.75rem","right":"1.75rem"}}}} -->
<div class="wp-block-group has-border-color" style="border-color:var(--wp--preset--color--border-subtle);border-width:1px;padding-top:2rem;padding-right:1.75rem;padding-bottom:2rem;padding-left:1.75rem"><!-- wp:paragraph {"textColor":"accent","style":{"typography":{"fontFamily":"var:preset|font-family|heading","fontSize":"2.25rem","fontWeight":"500"},"spacing":{"margin":{"bottom":"1rem"}}}} -->
...
<!-- wp:paragraph {"textColor":"muted","style":{"typography":{"fontSize":"0.875rem","lineHeight":"1.7","fontFamily":"var:preset|font-family|body","fontWeight":"200"}}} -->
<p class="has-muted-color has-text-color" style="font-family:var(--wp--preset--font-family--body);font-size:0.875rem;font-weight:200;line-height:1.7"><?php echo esc_html__( 'New elements are designed to be clearly legible as contemporary additions. Raw concrete, steel, and glass form a distinct material vocabulary that complements without mimicking the original fabric.', 'concrete-and-light' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"textColor":"muted","style":{"typography":{"fontSize":"0.875rem","lineHeight":"1.7","fontFamily":"var:preset|font-family|body","fontWeight":"200"}}} -->
<p class="has-muted-color has-text-color" style="font-family:var(--wp--preset--font-family--body);font-size:0.875rem;font-weight:200;line-height:1.7"><?php echo esc_html__( 'The restored building must serve its community today. We programme flexible spaces that invite new uses while preserving the spatial generosity and atmospheric quality of the original architecture.', 'concrete-and-light' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<p class="has-contrast-color has-text-color" style="font-family:var(--wp--preset--font-family--body);font-size:1rem;font-weight:200;line-height:1.75"><?php echo esc_html__( 'Originally built in 1887 as a merchant\'s warehouse in South Mumbai, The Colaba Vault lay dormant for decades before Concrete & Light was commissioned to transform it into a world-class contemporary art gallery.', 'concrete-and-light' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-contrast-color has-text-color" style="margin-top:1.25rem;font-family:var(--wp--preset--font-family--body);font-size:1rem;font-weight:200;line-height:1.75"><?php echo esc_html__( 'New board-formed concrete walls were threaded through the original stone arches, creating a sequence of intimate gallery rooms within the expansive warehouse shell. Zenithal skylights replace the deteriorated roof structure, flooding each space with the diffused tropical light that Mumbai offers so generously.', 'concrete-and-light' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"contrast","style":{"typography":{"fontSize":"1rem","lineHeight":"1.75","fontFamily":"var:preset|font-family|body","fontWeight":"200"},"spacing":{"margin":{"top":"1.25rem"}}}} -->
<p class="has-contrast-color has-text-color" style="margin-top:1.25rem;font-family:var(--wp--preset--font-family--body);font-size:1rem;font-weight:200;line-height:1.75"><?php echo esc_html__( 'The project received the UNESCO Asia-Pacific Award for Cultural Heritage Conservation in 2024, recognising the sensitive balance between preservation and contemporary architectural expression.', 'concrete-and-light' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
