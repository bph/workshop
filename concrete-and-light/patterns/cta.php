...
<h4 class="wp-block-heading has-text-align-center has-accent-color has-text-color" style="margin-bottom:1.5rem;font-family:var(--wp--preset--font-family--body);font-size:0.7rem;font-weight:300;letter-spacing:0.2em;text-transform:uppercase">Begin a conversation</h4>
<!-- /wp:heading -->
...
<h2 class="wp-block-heading has-text-align-center" style="font-family:var(--wp--preset--font-family--heading);font-size:clamp(2rem, 4vw, 3rem);font-weight:500;line-height:1.15">Every structure begins with a question.<br>What is yours?</h2>
<!-- /wp:heading -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-custom-font-size wp-element-button" style="padding-top:1rem;padding-right:2.5rem;padding-bottom:1rem;padding-left:2.5rem;font-family:var(--wp--preset--font-family--body);font-size:0.8125rem;font-weight:400;letter-spacing:0.15em;text-transform:uppercase">Get in touch</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->
