...
<figure class="wp-block-image size-large has-custom-border"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/project-bandra-cultural.png" alt="AI_IMAGE: A modern concrete cultural center in Bandra, Mumbai, with dramatic angular concrete volumes and deep recessed openings framing views of the Arabian Sea. Lush tropical vegetation creeps along the base. Board-formed concrete with warm patina under golden hour Mumbai light. Monumental yet intimate. | photorealistic | landscape" style="border-radius:0px"/></figure>
<!-- /wp:image -->

<!-- wp:group {"style":{"spacing":{"padding":{"left":"1.5rem","right":"1.5rem","top":"1.25rem"}}}} -->
<div class="wp-block-group" style="padding-top:1.25rem;padding-right:1.5rem;padding-left:1.5rem"><!-- wp:paragraph {"textColor":"accent","style":{"typography":{"fontSize":"0.7rem","fontFamily":"var:preset|font-family|body","fontWeight":"300","letterSpacing":"0.15em","textTransform":"uppercase"}}} -->
...
<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:33.33%"><!-- wp:group {"className":"project-card","style":{"border":{"width":"1px","color":"color-mix(in srgb, var:preset|color|contrast 8%, transparent)"},"spacing":{"padding":{"top":"0","bottom":"1.75rem","left":"0","right":"0"}}}} -->
<div class="wp-block-group project-card has-border-color" style="border-color:color-mix(in srgb, var(--wp--preset--color--contrast) 8%, transparent);border-width:1px;padding-top:0;padding-right:0;padding-bottom:1.75rem;padding-left:0"><!-- wp:image {"sizeSlug":"large","style":{"border":{"radius":"0px"}}} -->
<figure class="wp-block-image size-large has-custom-border"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/project-colaba-gallery.png" alt="AI_IMAGE: A contemporary art gallery carved into a restored heritage building in Colaba, Mumbai. Raw exposed concrete intervention walls contrast with original colonial-era stone arches. Diffused zenithal light from skylights illuminates a vast white exhibition hall. Heritage meets brutalism. | photorealistic | landscape" style="border-radius:0px"/></figure>
<!-- /wp:image -->
